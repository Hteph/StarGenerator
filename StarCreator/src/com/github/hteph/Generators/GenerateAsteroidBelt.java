...
public class GenerateAsteroidBelt {
	...
	public AsteroidBelt Generator(String name, String description, int orbitNumber, char orbitalObjectClass, Star orbitingAround, char[] orbitalObjectBasicList, double[] orbitalDistancesArray) {
		
		AsteroidBelt belt = new AsteroidBelt(name, description, orbitalDistancesArray[orbitNumber]);
